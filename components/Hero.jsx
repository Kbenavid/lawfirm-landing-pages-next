  ...
  return (
    <section className="min-h-screen bg-transparent">
      ...
      <div className="mx-auto w-full max-w-screen-2xl px-6 py-10">
        <div className="rounded-2xl bg-white/80 backdrop-blur-sm border border-white/60 shadow-xl p-8 lg:p-10">
          ...
          <div className="order-3 lg:order-none lg:col-span-4">
            ...
            <div className="relative overflow-hidden h-[560px] rounded-2xl ring-1 ring-black/5">
              <Image
                src="/Jose-Orozco.jpg"
                alt="Attorney Jose Orozco"
                width={400}
                height={500}
                className="h-auto w-full object-contain brightness-110 contrast-105"
              />
